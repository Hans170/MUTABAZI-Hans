...
public class URInternship extends Internship {
    ...
    public URInternship(String internshipId, Student student, String companyName, Supervisor supervisor, LocalDate startDate, LocalDate endDate) {
        super(internshipId, student, companyName, supervisor, startDate, endDate);
    }

    @Override
    public String generateReport() {
        return "UR Internship Report: \n" +
    ...
    public String trackProgress() {
        return "Progress details for UR Internship will be updated as required.";
    }
